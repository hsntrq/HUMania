...
{
    // it will display egg on (x, y) location, the size of pigeon is 25 width, 35 height
    moverRect = {x, y, 25, 35};
}

Egg::Egg() //default constructor
{
    // it will display egg on x = 30, y = 40 location, the size of pigeon is 25 width, 35 height
